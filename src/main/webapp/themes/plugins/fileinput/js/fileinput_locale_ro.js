...
(function ($) {
    ...
    $.fn.fileinputLocales['ro'] = {
        ...
        msgInvalidFileType: 'Tip de fișier incorect pentru "{name}". Sunt supportate doar fișiere de tipurile "{types}".',
        msgInvalidFileExtension: 'Extensie incorectă pentru "{name}". Sunt supportate doar extensiile "{extensions}".',
