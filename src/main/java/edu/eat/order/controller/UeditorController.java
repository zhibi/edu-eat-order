...
public class UeditorController {
    ...
    public String server(HttpServletRequest request, @RequestParam(defaultValue = "") String action) {
        String fileUploadPath = request.getServletContext().getRealPath("/");
        String result = new ActionEnter(request, fileUploadPath, "/config").exec();
